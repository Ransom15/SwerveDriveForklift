...
/**
 * This class is where the Sbulk of the robot should be declared. Since Command-based is a "declarative" paradigm, very
...
public class RobotContainer
{
  ...
  final CommandJoystick driverXbox = new CommandJoystick(1);
  ...
  public RobotContainer()
  {
    ...
    Command driveFieldOrientedAnglularVelocity = drivebase.driveCommand(
        ...
        () -> -.5*driverXbox.getRawAxis(2));

    Command driveFieldOrientedDirectAngleSim = drivebase.simDriveCommand(
        () -> MathUtil.applyDeadband(driverXbox.getRawAxis(0), OperatorConstants.LEFT_Y_DEADBAND),
